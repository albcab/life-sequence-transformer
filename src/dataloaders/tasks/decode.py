...
class Decode(Task):
    ...
    def encode_document(self, document: PersonDocument) -> "DecoderEncodedDocument":
...
@dataclass
class DecoderEncodedDocument(EncodedDocument[Decode]):
